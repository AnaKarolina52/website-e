...
class OrdersProduct extends \yii\db\ActiveRecord
{
    ...
    /**
     * {@inheritdoc}
     * @return \common\models\query\OrdersProductQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \common\models\query\OrdersProductQuery(get_called_class());
    }
}
