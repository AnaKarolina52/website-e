 ...
 *
 * @property OrderLocations $orderLocations
...
class Order extends \yii\db\ActiveRecord
{
     ...
     *
     * @return \yii\db\ActiveQuery|\common\models\query\OrderLocationsQuery
     */
    public function getOrderLocations()
    {
        return $this->hasOne(OrderLocations::className(), ['order_id' => 'id']);
    }
